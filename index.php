                    ...
                    <div class="card-body">
                        ...
                        <form action="registrasi.php" method="post" id="registerForm" style="display: none;">
                            ...
                            <input 
                                ...
                                autofocus
                                autocomplete="off">
                            <button type="submit" class="btn btn-primary mt-3" onclick="register()">Register</button>
                            <a href="#" class="btn btn-outline-warning mt-3" onclick="switchForms('loginForm')">Cancel</a>
                        </form>
                        </div>
                    </div>
                </div>
        ...
        function showAlert(){
            swal.fire({
                title 'Registrasi Berhasil',
                    text 'Anda Telah Berhasi Mendaftar.'
                    icon 'success',
